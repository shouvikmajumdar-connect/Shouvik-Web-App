...
if (!rootElement) {
  ...
  try {
    ...
    console.log("Track.it: Application mounted successfully.");
  } catch (error) {
    ...
    rootElement.innerHTML = `
      <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; padding: 20px; text-align: center; font-family: sans-serif; background: #0f172a; color: white;">
        ...
        <p style="color: #94a3b8; margin-bottom: 20px; font-size: 14px;">The application encountered a fatal error while starting.</p>
        ...
        <button onclick="window.location.reload()" style="margin-top: 24px; padding: 12px 24px; background: #0ea5e9; border: none; border-radius: 12px; color: white; font-weight: bold; cursor: pointer; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);">Reload Application</button>
      </div>
    `;
  }
}
